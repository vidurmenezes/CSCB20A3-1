CREATE DATABASE  IF NOT EXISTS `a3` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `a3`;
...
INSERT INTO `feedback` VALUES (1,'instid','q1 answer','q2 answer','q3 answer','q4 answer'),(2,'instaid','q1 answer','q2 answer','q3 answer','q4 answer'),(3,'instbid','q1 answer','q2 answer','q3 answer','q4 answer'),(5,'instid','testing question1','testing question2','testing question3','testing question4'),(6,'instaid','rth','hrth','greg','grewef');
...
INSERT INTO `marks` VALUES ('studenta',86.8,78.4,65.2,56.0,86.0,76.7,55.0,65.4),('studentb',98.0,45.1,56.0,64.8,75.6,46.0,78.1,65.5),('studentid',89.0,85.0,56.0,96.5,87.5,100.0,78.0,68.0);
...
INSERT INTO `remarks` VALUES (1,1,'quiz1','remark question 2','studentid'),(2,1,'quiz1','remark 3','studenta'),(3,1,'assignment1','remark 6','studentb'),(4,1,'quiz1','remark 1','studentb');
...
-- Dump completed on 2018-04-05 15:20:19
